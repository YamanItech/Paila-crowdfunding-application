...
function Musics() {
    const { data, loading } = getAxios("http://localhost:8000/api/v1/company/projects/category/Music");
        ...
        <>
            ...
            <div className="min-h-screen bg-white">
                <div className="relative h-[400px] flex items-center justify-center overflow-hidden">
                    ...
                    <h1 className="relative text-white text-7xl font-bold tracking-wider">Music</h1>
                </div>

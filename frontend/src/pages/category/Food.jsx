...
function Food() {
    const { data, loading } = getAxios("http://localhost:8000/api/v1/company/projects/category/Food");
            ...
            <div className="min-h-screen bg-white">
                <div className="relative h-[400px] flex items-center justify-center overflow-hidden">
                    <div className="absolute inset-0">
                        <img src={food} alt="All Categories" className="w-full h-full object-cover" />
                        <div className="absolute inset-0 bg-black bg-opacity-50" />
                    </div>
                    <h1 className="relative text-white text-7xl font-bold tracking-wider">Foods</h1>
                </div>

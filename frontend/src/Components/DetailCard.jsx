                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                    <div className="bg-card-bg rounded-xl p-4 relative">
                        <div className="relative aspect-[4/3] overflow-hidden rounded-lg">
                            {images.length > 0 ? (
                                <img src={images[currentImageIndex]} alt={projectName} className="w-full h-full object-cover" />
                            ) : (
                    ...
                    <div className="bg-card-bg rounded-xl p-6 w-5/6">
                        ...
                        <p className="text-1xl text-gray-600 text-center mt-4">
                            This project will only be funded if it reaches its goal by {detail.end_date || "N/A"}
                        </p>
                    </div>
                </div>
            </div>

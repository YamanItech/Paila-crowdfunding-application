...
const Header = () => {
    ...
    const handleSearch = (e) => {
        if (e.key === 'Enter') {
            e.preventDefault();
            // If user is not already on explore page, navigate there
      ...
      <header className="bg-white py-4 px-6 shadow-md flex items-center justify-between relative z-50">
          ...
          {userRole ? (
            <div className="relative">
                ...
                >
                    <div className="w-12 h-12 rounded-full bg-coral-100 flex items-center justify-center text-coral-600 border-2 border-transparent group-hover:border-coral-300 transition-all duration-200">

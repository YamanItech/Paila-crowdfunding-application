        ...
        if (paymentGateway === "esewa") {
            ...
            paymentConfig = {
                ...
                data: {
                    ...
                    purchase_order_name: "Crowdfunding",
                },
                headers: {
...
const paymentStatus = async (req, res) => {
    const { UUID, pidx, status } = req.body;
    try {
        ...
        if (payment_gateway === "esewa") {
            ...
            if (paymentStatusCheck.status === "COMPLETE") {
                ...
                if (transaction.product_id) {
                    const update = {
                        $inc: {
                            pledged_amount: transaction.amount, // Always increase pledged_amount
                        },
                    };
                    ...
                    if (!hasBackedBefore) {
                        update.$inc.noOfBacker = 1; // Increment backer count
                    }
